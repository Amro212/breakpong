...
# Load the pixel font
try:
    title_font = pygame.font.Font('Retro.ttf', 50)
    menu_font = pygame.font.Font('Retro.ttf', 32)
    help_font = pygame.font.Font('Retro.ttf', 19)
    score_font = pygame.font.Font('Retro.ttf', 30)
    small_menu_font = pygame.font.Font('Retro.ttf', 24)  # Smaller font for certain buttons
except:
...
while running:
    ...
    if current_state == STATE_INTRO:
        ...
        if ball.colliderect(paddle_left):
            ball_dx = abs(ball_dx)
            last_hit = "left"
            # Add spin: the paddle_left_speed influences ball_dy
